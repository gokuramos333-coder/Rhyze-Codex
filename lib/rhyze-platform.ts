...
export const ownedSchedule = [
  ...
  },
  {
    ...
    className: 'Core 360 with Carla Rio',
  ...
  },
  {
    ...
    className: 'Hypnotic Heels with Jessica',
    instructor: 'Jessica',
    photo: '/founders/instructor-jessica.jpg',
    room: 'Main Floor',
    duration: '75 min',
...
export const ownedMemberships = [
  ...
  },
  {
    ...
    blurb:
      'Founding members lock in unlimited access, specialty class access, and a unique 20% merch promo code.',
    perks: [
...
export const ownedEvents = [
  ...
  },
  {
    ...
    bookingHref: '/book/event/hypnotic-heels-jessica',
  },
  {
    ...
    bullets: [
      ...
      'Bring comfortable clothes, supportive shoes, and water',
      'Specialty pricing applies unless selected for VIP monthly access',
    ],
