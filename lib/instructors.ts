...
export const instructors: Instructor[] = [
  ...
  },
  {
    ...
    firstName: 'Adrianna',
    lastName: 'Jones',
    role: 'RYT 500 (YOGA & PILATES)',
    descriptor: 'VINYASA FLOW, PILATES & FUNCTIONAL MOVEMENT',
    photo: '/founders/instructor-adriana.jpg',
    bio: "Adrianna teaches yoga and Pilates for modern bodies. With more than seven years of teaching experience and a 500-hour Vinyasa certification, she combines traditional yoga practices, Pilates-inspired strength, stability, mobility, and functional movement. Her approach emphasizes mindful movement, intelligent alignment, and developing strength throughout the body's full range of motion.\n\nKnown for her focus on balance training, joint health, and the mind-muscle connection, Adrianna helps students build not only flexibility, but resilience, confidence, and trust in their bodies. She is passionate about making yoga and Pilates accessible to everyone, from first-time students and active older adults to seasoned practitioners looking to deepen their practice. Her classes offer an inviting blend of challenge, curiosity, and self-discovery, encouraging students to move with intention and leave feeling stronger, more connected, and more capable than when they arrived.",
    specialties: ['Vinyasa Flow', 'Pilates', 'Functional Movement'],
  },
  {
    slug: 'julie-reese',
    firstName: 'Julie',
  ...
  },
  {
    ...
    bio: 'Jessica brings over 30 years of dance experience to Rhyze, with training and performance background across ballet, hip-hop, modern, lyrical, ballroom, salsa, bachata, rumba, and cha-cha. Her passion for movement has led her to teach students of all ages, from children as young as 2½ years old to adults, helping each dancer build confidence, technique, and a lifelong love for movement.\n\nIn addition to dance instruction, Jessica is an experienced fitness instructor who creates fun, effective workouts that inspire people to stay active and reach their personal goals. Her teaching style focuses on making fitness accessible, engaging, and enjoyable for every fitness level.',
  ...
  },
  {
    ...
    firstName: 'Rachel',
    lastName: '',
    role: 'SOUL LINE-DANCING',
    descriptor: 'CONNECTION, RHYTHM & PURE JOY',
    photo: '/founders/instructor-rachel.jpg',
    bio: 'Rachel leads Soul Line-Dancing with connection, rhythm, and pure joy at the center of the room. She guides smooth, synchronized patterns set to the best in soul, neo-soul, old-school R&B, and country, creating a welcoming class where brand-new dancers and seasoned sliders can fit right in.',
    specialties: ['Soul Line-Dancing', 'R&B', 'Country'],
  },
  {
    slug: 'mackenzie-heffernan',
    firstName: 'Mackenzie',
    lastName: 'Heffernan',
    role: 'GROUP FITNESS / YOGA / POUND',
    descriptor: 'GLOBAL HIIT, VINYASA & POUND',
    photo: '/founders/instructor-mackenzie-heffernan.jpg',
    bio: 'Mackenzie Heffernan was born and raised in Sussex County. Her wellness journey started with nonprofits such as PRETTY GIRLS SWEAT and Girls on the Run. She first became certified to teach POUND fitness, a cardio Pilates workout with drumsticks. While attending Rutgers University, she joined the wellness team at Rutgers Recreation and received her NAFC Group Fitness Certification.\n\nAfter graduating college, Mackenzie taught at boutique studios and gyms, then completed her 200-hour Yoga Teacher Training with Moksha Yoga Amazonica. When she became a mom, teaching continued to be part of her life and motherhood became her motivation. She began working at the YMCA in Monmouth County in 2018 and then in Sussex County in 2022. Mackenzie is now proud to be on the Personal Training Team and ready to help students reach their wellness goals.',
    specialties: ['POUND', 'Global HIIT', 'Vinyasa Yoga'],
  },
  {
    slug: 'carla-hotrock',
    firstName: 'Carla',
