...
export const instructors: Instructor[] = [
  ...
  },
  {
    ...
    photo: '/founders/instructor-nicole.jpg',
    bio: 'Dance has been Nicole’s absolute world for as long as she can remember. From the very first time she stepped onto the floor, movement became her language, her passion, and her constant. That lifelong love for dance shaped who she is and paved the way for an incredible journey.\n\nToday, Nicole’s world is wonderfully full. Being a mom to her little girls is her greatest pride and joy, and watching them now take their very first steps on their own dance journeys is genuinely magical—it is like watching her own childhood come alive all over again through their eyes.\n\nTeaching allows Nicole to bring everything she loves full circle. Every single day in the studio, she gets to share her lifelong passion, connect with amazing people, and inspire others to find their own rhythm. She is so grateful to live a life surrounded by family, dance, and community.',
  ...
  },
  {
    ...
    bio: "Rachel brings connection, rhythm, and pure joy to the Rhyze floor through Soul Line-Dancing. Her class guides students through smooth, synchronized patterns set to the best in soul, neo-soul, old-school R&B, and country. Whether someone has two left feet or is already a seasoned slider, Rachel creates a welcoming space where everyone can fit right in.",
    specialties: ['Soul Line-Dancing', 'Rhythm', 'Community'],
  },
  {
    ...
    descriptor: 'GLOBAL HIIT, VINYASA & CARDIO PILATES',
    photo: '/founders/instructor-mackenzie.jpg',
    bio: 'Mackenzie Heffernan was born and raised in Sussex County. Her wellness journey started with nonprofits such as PRETTY GIRLS SWEAT and Girls on the Run. She first became certified to teach POUND fitness, a cardio Pilates workout with drumsticks. While attending Rutgers University, she joined the wellness team at Rutgers Recreation and received her NAFC Group Fitness Certification.\n\nAfter graduating college, Mackenzie taught at boutique studios and gyms, then completed her 200-hour Yoga Teacher Training with Moksha Yoga Amazonica. When she became a mom, motherhood became her motivation and she continued teaching. She began working at the YMCA in Monmouth County in 2018 and then in Sussex County in 2022. Mackenzie is proud to be part of the personal training team and ready to help students reach their wellness goals.',
    specialties: ['POUND', 'Global HIIT', 'Yoga', 'Vinyasa'],
  },
  {
    slug: 'carla-hotrock',
    firstName: 'Carla',
